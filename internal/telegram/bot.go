...
const (
	msgStart = "Привет! Вы подписались на напоминания о подписании табеля.\n" +
		"Напоминания приходят дважды в месяц — около 15-го числа и в конце месяца " +
		"(30-е, 31-е или последний день февраля), с учётом выходных и праздников, в 11:00 по МСК.\n\n" +
